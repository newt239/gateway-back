...
router.post('/:activity_type', verifyToken, function (req: express.Request, res: express.Response) {
    ...
    if (activity_type === "enter" || activity_type === "exit" || activity_type === "pass") {
        ...
        const sql: string = `INSERT INTO gateway.activity (activity_id, guest_id, exhibit_id, userid, activity_type, timestamp, available) VALUES ('${activity_id}', '${guest_id}', '${exhibit_id}', '${res.locals.userid}', '${activity_type}', '${timestamp}', 1)`;
